...
export const alt = 'フリ校 Udemy セール Twitter画像';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ fontSize: 28, color: '#93c5fd', display: 'flex' }}>フリーランスの学校</div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 18, color: '#cbd5e1', fontSize: 26 }}>
          <div style={{ display: 'flex' }}>ChatGPT・AI活用</div>
          <div style={{ display: 'flex' }}>|</div>
          <div style={{ display: 'flex' }}>AIプログラミング</div>
          <div style={{ display: 'flex' }}>|</div>
          <div style={{ display: 'flex' }}>Discord Bot</div>
          <div style={{ display: 'flex' }}>|</div>
          <div style={{ display: 'flex' }}>デザイン・動画</div>
        </div>
      </div>
    ),
    {
