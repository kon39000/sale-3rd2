...
export default function Reviews() {
  ...
  return (
    <section id="reviews" className="py-12 sm:py-16 lg:py-20 bg-slate-950 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {reviewsData.map((review) => (
            <div key={review.id} className="bg-slate-900 border border-slate-800 rounded-xl p-4 sm:p-6 space-y-3 sm:space-y-4">
